...
async function seed() {
  ...
  try {
    ...
    const biens = [
      ...
      { owner: aishaId, type: 'maison', area: 150, bedrooms: 3, bathrooms: 2, address: 'Bonapriso', district: 'Bonapriso', city: 'Douala', lat: 4.05, lon: 9.77, title: 'Maison moderne Bonapriso', price: 200000, desc: 'Maison moderne avec jardin et garage.', photos: ['https://images.unsplash.com/photo-1572120360610-d971b9d7761c?w=800', 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800'] },
      { owner: aishaId, type: 'appartement', area: 85, bedrooms: 2, bathrooms: 1, address: 'Akwa', district: 'Akwa', city: 'Douala', lat: 4.057, lon: 9.701, title: 'Appartement standing Akwa', price: 180000, desc: 'Bel appartement avec vue sur la ville.', photos: ['https://images.unsplash.com/photo-1502672023488-70e25813eb80?w=800', 'https://images.unsplash.com/photo-1560448204-e02f11c3d8e6?w=800'] },
    ...
    await addMessage(conv2, agent2Id, 'Voici quelques photos supplémentaires du studio :', { attachment_url: 'https://images.unsplash.com/photo-1554995207-c18c6f789470?w=800', attachment_type: 'image', attachment_name: 'studio_photo3.jpg' });
    ...
    await addMessage(conv3, aishaId, 'On peut discuter d\'une éventuelle négociation lors de la visite. Voici les photos :', { attachment_url: 'https://images.unsplash.com/photo-1572120360610-d971b9d7761c?w=800', attachment_type: 'image', attachment_name: 'maison_bonapriso.jpg' });
